...
under 24 hours before that current time). Decide whether the trigger
condition fires. If it does not, say so explicitly and do NOT run a summit
or touch the ideas ledger — just continue with normal dispatch/build work
instead.
