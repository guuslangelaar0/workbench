...
chk "minimal CLAUDE routes resume catchups to SESSION_STATE" "grep -q 'where were we' '$T/minimal/CLAUDE.md.tmpl' && grep -q 'SESSION_STATE' '$T/minimal/CLAUDE.md.tmpl'"
chk "full CLAUDE routes resume catchups to SESSION_STATE" "grep -q 'where were we' '$T/full/CLAUDE.md.tmpl' && grep -q 'SESSION_STATE' '$T/full/CLAUDE.md.tmpl'"
chk "minimal CLAUDE makes catchups read-only" "grep -qi 'read-only' '$T/minimal/CLAUDE.md.tmpl' && grep -qi 'do not.*inception' '$T/minimal/CLAUDE.md.tmpl'"
chk "full CLAUDE makes catchups read-only" "grep -qi 'read-only' '$T/full/CLAUDE.md.tmpl' && grep -qi 'do not.*inception' '$T/full/CLAUDE.md.tmpl'"
