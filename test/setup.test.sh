...
printf '{ "initlab": { "version": "0.0.0", "initialized_at": "x" }, "project": { "name": "Prewritten", "kind": "existing" }, "way_of_working": { "models": "better" }, "lifecycle": { "states": ["backlog"], "in_review_cap": 7 } }' > "$TMP/.workbench/config.json"
...
chk "bare initlab command"      "[ -f '$HERE/commands/initlab.md' ]"
